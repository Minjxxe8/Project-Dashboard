    ...
    return (
        <>
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 h-[600px] w-[950px] rounded-2xl shadow-[0px_0px_67px_34px_rgba(0,_0,_0,_0.1)] flex flex-col p-10 backdrop-blur-3xl border-1">
                ...
                <ValidatedFloatingInput value={review} onChange={e => setReview(e.target.value)} label="Review" height="h-35"/>

                <div>
                    <label htmlFor="file-input" className="sr-only">Choose file</label>
                    <input onChange={e => setFile(e.target.files?.[0] || null)} type="file" name="file-input" id="file-input" className="block w-full border mb-4 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none
                ...
                <button onClick={handleButtonClick} type="button" className="
                        ...
                        w-fit place-self-end mt-5 cursor-pointer">
                    Finish
                </button>
